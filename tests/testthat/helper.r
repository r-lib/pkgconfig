...
install_tmp_pkg <- function(..., pkg_name, lib_dir, imports = "pkgconfig") {
  ...
  ## Make it installable: remove man, add pkgconfig dependency
...
load_tmp_pkgs <- function(..., lib_dir = tempfile(), imports = "pkgconfig") {
